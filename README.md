...
## React Updates
For this part of the project, I honestly could not even get my `npm run dev` to work...so I did not deploy it to my production. I fully expect to take a huge hit for this...But I did try to create the React application, so I am hoping for some points. My code can be seen in my GitHub repository, however it is NOT in my production environment
