        ...
        <main className="container-fluid">
          ...
          <div>
            ...
            <div className="d-flex flex-column">
              <span className="m-3">
                Wynn's Furniture is a three generation family owned business.
                Ross and Thayle Wynn started the business in 1947 after settling
                in Ashton, Idaho to raise their large family of 11. Ross raised
                his 6 sons all learning the flooring industry. Their youngest
                son, Sam, spent much of his childhood and teenage years working
                with his brothers on the job sites before formally taking over
                the business in his adulthood. A generation later, Sam's oldest
                son, Ryker, did the same; working side by side with his dad and
                grandpa throughout his youth learning the perfected craft. At
                Wynn's we place emphasis on customly perfected work ensuring the
                highest quality outcome availiable in the luxury flooring
                industry.
              </span>
                ...
                <div className="m-3 d-flex flex-column">
                  ...
                  <div className="border border-2 rounded d-flex flex-row">
                    ...
                    <span className="text-center btn-group-vertical m-3">
                      Sam and Stacy met at Utah State University. They soon
                      later got married in 1990 and started their family.
