    ...
    <body class="text-bg-dark">
        ...
        <div>
          <nav class="nav nav-tabs" role="navigation">
            <div class="container-fluid d-flex justify-content-around">
              ...
              <a href="floor.html" class="nav-link text-white">
                Floor Coverings
              </a>
              <a href="window.html" class="nav-link active text-bg-dark">
                Window Coverings
              </a>
      ...
      <main>
        <div class="lead text-center mt-3">
          There is a wide variety of window coverings to choose from, to see
          more visit us in store!
        </div>
        <div class="d-flex flex-row row-3 m-3">
          <div class="w-50">
            <span>
              Here is a list of some of the suppliers we use for window
              coverings!
            </span>
            <ul>
              <li>Blynco</li>
