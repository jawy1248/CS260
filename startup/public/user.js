async function loadSearches() {
    ...
    '<div class="col d-flex flex-column m-3">' +
        ...
        '<img class="m-1 rounded-3" src="images/furn/furn1.jpeg" alt="Furniture Set 1" height="250" />' +
    '</div>';
    
    let pic2HTML = 
    '<div class="col d-flex flex-column m-3">' +
        '<span class="h5">Furniture Set 2</span>' +
        '<img class="m-1 rounded-3" src="images/furn/furn2.jpg" alt="Furniture Set 2" height="250" />' +
    '</div>';
    
    let pic3HTML = 
    '<div class="col d-flex flex-column m-3">' +
        '<span class="h5">Furniture Set 3</span>' +
        '<img class="m-1 rounded-3" src="images/furn/furn3.jpg" alt="Furniture Set 3" height="250" />' +
    '</div>';
    
    let pic4HTML = 
    '<div class="col d-flex flex-column m-3">' +
        '<span class="h5">Furniture Set 4</span>' +
        '<img class="m-1 rounded-3" src="images/furn/furn4.jpg" alt="Furniture Set 4" height="250" />' +
    '</div>';
    
    let pic5HTML = 
    '<div class="col d-flex flex-column m-3">' +
        '<span class="h5">Furniture Set 5</span>' +
        '<img class="m-1 rounded-3" src="images/furn/furn5.jpg" alt="Furniture Set 5" height="250" />' +
    '</div>';
    
    let pic6HTML = 
    '<div class="col d-flex flex-column m-3">' +
        '<span class="h5">Furniture Set 6</span>' +
        '<img class="m-1 rounded-3" src="images/furn/furn6.jpg" alt="Furniture Set 6" height="250" />' +
    '</div>';
